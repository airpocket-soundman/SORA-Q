...
typedef struct {
    void *buffer_pool[2];
    void *param_pool[6];
    rt_buffer_allocate_type_t variable_buffers_allocate_type[15];
    ...
    int v5_shape[2];
    rt_variable_t v6; ///< Affine/affine/b
    int v6_shape[1];
    rt_variable_t v7; ///< Convolution
    int v7_shape[4];
    rt_variable_t v8; ///< MaxPooling
    int v8_shape[4];
    rt_variable_t v9; ///< ReLU
    int v9_shape[4];
    rt_variable_t v10; ///< Convolution_2
    int v10_shape[4];
    rt_variable_t v11; ///< MaxPooling_2
    int v11_shape[4];
    rt_variable_t v12; ///< ReLU_2
    int v12_shape[4];
    rt_variable_t v13; ///< Affine
    int v13_shape[2];
    rt_variable_t v14; ///< Softmax
    int v14_shape[2];
...
void* nnablart_mainruntime_allocate_context(void** params)
{
    ...
    arg_f1_kernel.data[0] = 3;
    arg_f1_kernel.data[1] = 3;
    ...
    arg_f1_stride.data[0] = 2;
    arg_f1_stride.data[1] = 2;
    ...
    arg_f4_kernel.data[0] = 3;
    arg_f4_kernel.data[1] = 3;
    ...
    arg_f4_stride.data[0] = 3;
    arg_f4_stride.data[1] = 3;
    ...
    // ReLU
    c->f5_local_context = malloc(sizeof(relu_local_context_t));
    ...
    (c->f5_local_context)->inplace = 1;
    allocate_relu_local_context(&(c->f5));
    // Affine
    ...
    // Softmax
    c->f7_local_context = malloc(sizeof(softmax_local_context_t));
    ...
    (c->f7_local_context)->axis = 1;
    allocate_softmax_local_context(&(c->f7));
    return (void*)c;
}
...
int nnablart_mainruntime_free_context(void* context)
{
    ...
    free_softmax_local_context(&(c->f7));
