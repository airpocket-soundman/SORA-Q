...
/// Input buffer sizes.
#define NNABLART_MAINRUNTIME_INPUT0_SIZE (1024)
...
/// Output buffer sizes.
#define NNABLART_MAINRUNTIME_OUTPUT0_SIZE (25)
/// Pointer of allocated buffer.
float* nnablart_mainruntime_output_buffer(void* context, int index);
/// Number of parameter buffers.
#define NNABLART_MAINRUNTIME_NUM_OF_PARAM_BUFFERS (6)
/// Parameter buffer sizes.
#define NNABLART_MAINRUNTIME_PARAM0_SIZE (288)
#define NNABLART_MAINRUNTIME_PARAM1_SIZE (32)
#define NNABLART_MAINRUNTIME_PARAM2_SIZE (18432)
#define NNABLART_MAINRUNTIME_PARAM3_SIZE (64)
#define NNABLART_MAINRUNTIME_PARAM4_SIZE (270400)
#define NNABLART_MAINRUNTIME_PARAM5_SIZE (25)
/// Pointer of allocated buffer.
